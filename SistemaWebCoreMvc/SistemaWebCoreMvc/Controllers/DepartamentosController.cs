...
namespace SistemaWebCoreMvc.Controllers
{
    ...
    {
        private readonly SistemaWebCoreMvcContext _context;

        public DepartamentosController(SistemaWebCoreMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SistemaWebCoreMvcContext.Departamento'  is null.");
            }
            var departamento = await _context.Departamento.FindAsync(id);
            if (departamento != null)
            {
